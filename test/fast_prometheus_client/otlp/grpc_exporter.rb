...
require "fast_prometheus_client/otlp/grpc_exporter"
require "fast_prometheus_client/otlp/service_interface"
require "async/grpc/dispatcher"
require "async/grpc/service"
require "sus/fixtures/async/http"

describe FastPrometheusClient::OTLP::GRPCExporter do
  ...
  let(:test_service) do
    ...
    Class.new(Async::GRPC::Service) do
      ...
      FastPrometheusClient::OTLP::MetricsServiceInterface,
  ...
  let(:exporter) do
    FastPrometheusClient::OTLP::GRPCExporter.new(
      endpoint: bound_url,
      registry: registry
    )
  end
