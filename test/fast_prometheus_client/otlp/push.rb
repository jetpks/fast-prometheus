...
require "fast_prometheus_client/otlp/push"
require "sus/fixtures/async"

describe FastPrometheusClient::OTLP::Push do
  ...
  describe "basic loop" do
    it "calls exporter.export at least twice" do
      ...
      push = FastPrometheusClient::OTLP::Push.new(exporter: fake_exporter, interval: 0.01)
      push.run
