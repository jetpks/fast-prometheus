...
describe Fast::Prometheus::Gauge do
  let(:gauge) { Fast::Prometheus::Gauge.new(:temperature, docstring: "Temperature") }
  ...
  describe "labeled series" do
    let(:labeled) { Fast::Prometheus::Gauge.new(:temp, docstring: "Temp", labels: [:zone]) }
