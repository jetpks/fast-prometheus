...
describe Fast::Prometheus::Counter do
  let(:counter) { Fast::Prometheus::Counter.new(:requests, docstring: "Request count") }
  ...
  describe "labeled series" do
    let(:labeled) { Fast::Prometheus::Counter.new(:requests, docstring: "Count", labels: [:method]) }
